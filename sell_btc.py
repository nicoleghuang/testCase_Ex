...
for k,v in account.diction().items():
    ...
    browser.find_element_by_xpath('//*[@id="__nuxt"]/div[2]/div[3]/div/div[5]/div[2]/div/form/div[2]/div[1]/div/input').send_keys(k)
    browser.find_element_by_xpath('//*[@id="__nuxt"]/div[2]/div[3]/div/div[5]/div[2]/div/form/div[2]/div[2]/div/input').send_keys(v)
    browser.implicitly_wait(10)
    browser.find_element_by_xpath('//*[@id="__nuxt"]/div[2]/div[3]/div/div[5]/div[2]/div/form/div[4]/button').click()
    time.sleep(15)
    #browser.implicitly_wait(10)
    ...
    # SEL btc
    id_price='//*[@id="__nuxt"]/div[2]/div[3]/div/section/div[2]/div/div[2]/div[2]/div[1]/div[1]/div[2]/div[5]/input'
    id_quantity='//*[@id="__nuxt"]/div[2]/div[3]/div/section/div[2]/div/div[2]/div[2]/div[1]/div[1]/div[2]/div[6]/input'
    id_submit='//*[@id="__nuxt"]/div[2]/div[3]/div/section/div[2]/div/div[2]/div[2]/div[1]/div[1]/div[2]/div[8]/button'
    for i in range(100):
        m=6.01+i*0.01
        print m
        n=0.01+i*0.1
        ...
        #browser.find_element_by_xpath(id_price).clear()
