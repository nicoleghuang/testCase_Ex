...
for k,v in account.diction().items():
    ...
    # choose CDY trade pair
    #browser.find_element_by_xpath('/html/body/div/div[2]/div[1]/ul/li[2]/a').click()
    browser.find_element_by_xpath('//*[@id="__nuxt"]/div[2]/div[3]/div/section/div[1]/div/div/div[2]/div[6]/a').click()
    print 'choose cdy trade pair successfully'
    ...
    for i in range(100):
        ...
        browser.find_element_by_xpath(id_quantity).send_keys(Keys.CONTROL, 'a')
